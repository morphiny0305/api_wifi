...
import static dao.History_DAO.searchHistory;
...
public class Wifi_DAO {
    ...
    public List<Wifi_DTO> getNearestWifiList(String lat, String lnt) {

        connection = null;
        preparedStatement = null;
        resultSet = null;

        List<Wifi_DTO> list = new ArrayList<>();
        ...
        try {
            ...
            while (resultSet.next()) {
                Wifi_DTO wifiDTO = Wifi_DTO.builder()
    ...
    public List<Wifi_DTO> selectWifiList(String mgrNo, double distance) {
    ...
    public Wifi_DTO selectWifi(String mgrNo) {
        Wifi_DTO wifiDTO = new Wifi_DTO();
